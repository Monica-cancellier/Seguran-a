...
// MessageDigest (MD5, SHA-1, SHA-256, SHA-512)
        ...
        for (String algorithm : algorithms) {
            ...
            hashedPassword = ads.seg.PasswordHashing.hashPasswordWithMessageDigest(password, salt, algorithm);
...
// PBKDF2
        ...
        S_RANDOM.nextBytes(salt);
        long start = System.nanoTime();
        hashedPassword = ads.seg.PasswordHashing.hashPasswordWithPBKDF2(password, salt, pbkdf2Algorithm, iterations, keyLength);
        long end = System.nanoTime();
        String hashBase64 = encoder.encodeToString(hashedPassword != null ? hashedPassword : new byte[0]);
